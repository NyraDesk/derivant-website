            ...
            <div className="bg-[#E8DCC8] rounded-3xl h-[400px] flex flex-col shadow-xl mt-auto overflow-hidden p-8">
              ...
              <div className="flex-1 flex items-center justify-center">
                <video
                  ...
                  playsInline
                >
                  <source src="/src/assets/calendario demo uff.mov" type="video/mp4" />
                  <source src="/src/assets/calendario demo uff.mov" type="video/quicktime" />
            ...
            <div className="bg-[#E8DCC8] rounded-3xl h-[450px] flex flex-col shadow-xl overflow-hidden p-8">
              ...
              <div className="flex-1 flex items-center justify-center">
                <video
                  ...
                  playsInline
                >
                  <source src="/src/assets/todo ok.mov" type="video/mp4" />
                  <source src="/src/assets/todo ok.mov" type="video/quicktime" />
                  Il tuo browser non supporta il tag video.
                </video>
              </div>
            </div>
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#E8DCC8] rounded-3xl h-[750px] flex flex-col shadow-xl overflow-hidden p-8">
              ...
              <video
                ...
                playsInline
              >
                <source src="/src/assets/note demo ufficiale.mov" type="video/mp4" />
                <source src="/src/assets/note demo ufficiale.mov" type="video/quicktime" />
                Il tuo browser non supporta il tag video.
              </video>
            </div>
          </div>
